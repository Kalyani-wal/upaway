...
const AddTeamMember = ({ isOpen, setIsOpen }) => {
  const stylesImg = {
    width: "20px",
    marginRight: "8px",
    marginTop: "-4px",
    ...
    >
      ...
      <Formik>
        <Form className="form-team-member">
          ...
          />
          <Select label="Permission" name="permission" options={tripSupport} />
          </div>
          <div className="butons-wrapper">
              <button className="button btn-small btn-smaller btn-transparent">Cancel</button>
              <button className="button btn-small btn-team">Add Team Member</button>
            </div>
        </Form>
      </Formik>
    </CollapsiblePanel>
